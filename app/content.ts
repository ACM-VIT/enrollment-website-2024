...
> Incorporate hands-on app development challenges, workshops, and interactive demos within the hackathons held by ACM like HackStory and Tiny Hack.💻🛠️
...
> Incorporate hands-on coding exercises, workshops and interactive demonstrations into "Codex Cryptum".🛠️💡
...
## WHAT WE DO 🛠️
> Design visually appealing graphics, UI/UX,  themes, and branding materials that capture the essence of "Cryptic Hunt" including a captivating logo, website, and app. 🖼️💻
...
> Construct intricate and challenging puzzles for "Cryptic Hunt" and "Reverse Coding" by exploring various ciphers, decoders, and puzzle-solving techniques to craft a captivating and intellectually stimulating experience for participants.🕵️‍♂️🧩
...
> Conduct insightful workshops like "Codex Cryptum" by researching deeper into innovative applications within the fields of Cryptography, Cybersecurity and Blockchain and provide a hands-on experience for participants.🛠️🔍
...
## WHAT WE DO 🛠️
> Develop a comprehensive event portal for events like Cryptic Hunt and Hackathons featuring registration forms, event schedule, live updates, and submission guidelines. Ensure a responsive design that caters to participants accessing the portal during the events.📅🖥️
