  ...
  const commands = {
    help: (
      <span>
        ...
        ┝ register &lt;domain&gt; - registers a domain <br />┝ formsubmit
        &lt;domain&gt; - submits a form for a domain, <br />└ exit - exits the
        terminal
      </span>
    ),
    exit: () => {
    ...
    chair:
      "Manav Muthanna: the one who hustles so hard, he'd even trade his ID card for ACM.",
    ...
    wChair:
      "Anshuman Gupta: he infuses every interaction with a potent blend of engaging humor and communication wizardry",
    ...
    dev: (
      <span>
        ...
        <br />
        Assisted by - Shane Shaji Thomas, Souparnika Jayagopal, Eshita Jain,
        Kushagra Rohatgi, Srija Puvvada , K Dhanush Baalaji
      </span>
    ),
